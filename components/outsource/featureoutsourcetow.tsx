...
className="absolute -top-30 left-0 w-140 h-110 bg-[#00d4ff]/35 rounded-full mix-blend-multiply filter blur-2xl opacity-30 z-10"
style={{
borderRadius: '20%',
...
// }}
transition={{ type: 'spring', stiffness: 25, damping: 35, mass: 1.5 }}
className="absolute -top-20 -left-10   w-80 h-80 bg-[#00d4ff]/35 rounded-full mix-blend-multiply filter blur-2xl opacity-50 z-10"
style={{
borderRadius: '20%',
transformOrigin: 'center',
