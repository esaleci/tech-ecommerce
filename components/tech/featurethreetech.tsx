...
import { DatabaseIcon, Plus, Redo2Icon, ShieldCheckIcon, UserPlus2Icon, Waypoints, WaypointsIcon,CoinsIcon, HandCoinsIcon } from "lucide-react";

export default function FeatureThreeTech() {
...
<div
className="absolute -top-10 left-32   w-70 h-70 bg-[#00d4ff]/35 rounded-full mix-blend-multiply filter blur-2xl opacity-70 z-10"
style={{
borderRadius: '20%',
transformOrigin: 'center',
...
<div className="inline-flex items-center gap-4 rounded-2xl bg-white px-4 py-3 shadow-sm">
 ...
 <div className="flex flex-col md:flex-row lg:flex-col gap-4">
            ...
            >
                ...
                <DatabaseIcon className="w-8 h-8 text-slate-100" />
                </div>
                <h3 className="mb-4 text-xl font-semibold text-slate-900">Database Management</h3>
                <p className="text-sm text-muted">
                Reliable database solutions built to ensure data integrity, performance optimization, and real-time insights for smarter business decisions.
            </p>
              </div>
              ...
              <div  className={`rounded-2xl bg-white p-8 text-left  `}
                ...
                <HandCoinsIcon className="w-8 h-8 text-slate-100" />
                </div>
                <h3 className="mb-4 text-xl font-semibold text-slate-900">Payment Gateways</h3>
                <p className="text-sm text-muted">
                Secure payment gateway integrations that enable seamless transactions, global payment support, and reliable checkout experiences.
                </p>
              </div>
