...
export default function Navbar2() {
  ...
  return (
    <header className="w-full fixed top-0 left-0 right-0 z-[100] transition-all duration-500">
      ...
      <div className={`w-full  max-w-7xl mx-auto  px-4 xl:px-6  flex items-center justify-between relative z-50 px-5 transition-all duration-500 ${isScrolled ? "h-20" : "h-24"}`}>
