...
export default function FeatureStrategyThree() {
 ...
 <div className="space-y-6 ">
            ...
            Data-driven media strategies designed to optimize channel selection, audience reach, and budget allocation for maximum impact and efficiency.
            </p>

           <div className="flex flex-row justify-between  items-start">
           <ul className="space-y-4 pt-4">
              {[
                "Smart channel selection and media planning",
                "Optimized budget allocation for higher ROI",
                "Performance tracking and continuous refinement",
              ].map((item, i) => (
