...
export default function FeatureMarketing() {
  ...
  >
      ...
      <div className=" relative  py-8 md:py-16 lg:py-16 xl:py-24">
 ...
 <div className="space-y-6 text-left ">
          ...
          className="absolute -top-10 left-0 md:-top-30 md:left-0  lg:-top-50 lg:left-0 w-100 h-70 lg:w-140 lg:h-110  bg-[#00d4ff]/35 rounded-full mix-blend-multiply filter blur-2xl opacity-80 z-10"
          style={{
            borderRadius: '20%',
...
<div
          ...
          className="absolute -bottom-20 left-0 md:-bottom-30 lg:left-0  lg:-bottom-50 lg:left-32   w-70 h-70 bg-[#00d4ff]/35 rounded-full mix-blend-multiply filter blur-2xl opacity-70 z-10"
          style={{
            borderRadius: '20%',
            transformOrigin: 'center',
        ...
        />
            {/* main card */}
            <div className="relative z-10 hidden md:block  rounded-xl shadow-soft w-50 h-20 shadow-xl  p-8 ">
